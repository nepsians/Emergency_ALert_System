...
public class BackgroundTask extends AsyncTask<String,Void,String> {
    ...
    protected String doInBackground(String... voids) {
            String type=voids[0];
            String login_url="http://nepsian.000webhostapp.com/login.php";
            String register_url="http://nepsian.000webhostapp.com/Register.php";
            ...
            } else if (type.equals("Register")||type.equals("upload")){
